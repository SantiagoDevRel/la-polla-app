...
describe('final scores and identity', () => {
  it('supports the twenty-one requested competitions', () => expect(Object.values(RESULT_LEAGUES).sort((a,b)=>a-b))
    .toEqual([2,3,5,11,13,39,61,71,73,78,88,94,128,130,135,140,239,241,253,262,848]));
