...
describe('final scores and identity', () => {
  it('supports the ten requested competitions (Europa League included)', () => expect(Object.values(RESULT_LEAGUES).sort((a,b)=>a-b)).toEqual([2,3,11,13,39,61,78,135,140,239]));
