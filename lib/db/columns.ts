...
export const POLLA_COLUMNS =
  "id, slug, name, description, created_by, type, status, tournament, tournaments, scope, match_ids, buy_in_amount, currency, platform_fee_pct, prize_pool, points_exact, points_winner, points_one_team, points_goal_diff, points_correct_result, scoring_mode, score_120, advance_bonus, kc_mode_changed_at, advance_bonus_from, payment_mode, admin_payment_instructions, invite_token, join_code, prize_distribution, created_at, starts_at, ends_at" as const;
...
export const MATCH_COLUMNS =
  "id, external_id, tournament, match_day, phase, home_team, away_team, home_team_flag, away_team_flag, home_team_abbr, away_team_abbr, scheduled_at, scheduled_at_confirmed, venue, home_score, away_score, status, elapsed, live_status_detail, final_verified_at, fulltime_home_score, fulltime_away_score, penalty_home, penalty_away, advancer, notified_closing, created_at" as const;

export const PREDICTION_COLUMNS =
  "id, polla_id, user_id, match_id, predicted_home, predicted_away, advance_pick, submitted_at, locked, visible, points_earned" as const;
