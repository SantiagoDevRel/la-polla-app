...
const competitions = [
  { slug: 'sudamericana_2026', league: 11, name: 'Copa Sudamericana', publicSlug: 'copa-sudamericana' },
  { slug: 'europa_2026', league: 3, name: 'Europa League', publicSlug: 'europa-league' },
];
