        ...
        <li key={p.id} className="rounded-md border border-border-default bg-bg-elevated/60 p-3 transition-colors duration-200 hover:border-border-strong">
          ...
          {!paid && <div className="mt-3 flex flex-wrap gap-2">
            <button
              ...
              aria-label={`Rechazar el pago de ${p.jugador}${p.participacion != null ? `, cupo ${p.participacion}` : ""}`}
            ...
            <button
              ...
              aria-label={`Aprobar el pago de ${p.jugador}${p.participacion != null ? `, cupo ${p.participacion}` : ""}`}
          ...
          {paid && (p.puedeDesmarcar ? (correctionId === p.id ? (
            <div role="group" aria-label={`Corregir pago de ${p.jugador}${p.participacion != null ? `, cupo ${p.participacion}` : ""}`} className="mt-4 space-y-3 rounded-md border border-amber/40 p-3">
