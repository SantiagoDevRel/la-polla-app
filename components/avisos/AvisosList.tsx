...
// Event-type icon resolution. The four moment-videos generated by Pixa
// (celebration / rankup / rivales / triste) each provide a poster frame
// that stands in for a lucide glyph in the notification icon well, so
// the feed now carries the same cartoon language the videos will use
// downstream. polla_finished + polla_started stay on lucide glyphs —
// they are structural events, not pollito moments.
interface TypeVisual {
  // Either a static poster path (moment types) or a lucide icon
  // component (structural types). Exactly one is set.
  posterSrc?: string;
  Icon?: typeof Trophy;
  tint: string;
  ring: string;
