...
export default async function MatchIssuesPage() {
  ...
  return <div className="px-4 pb-28 pt-5">
    ...
    <p className="mt-2 mb-5 text-[15px] leading-[1.45] text-text-secondary">Partidos suspendidos, aplazados, cancelados, abandonados o con el marcador demorado en pollas activas. Decide qué pasa con cada uno.</p>
    {result.ok
