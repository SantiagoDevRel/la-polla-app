// app/(app)/admin/pollas/page.tsx — donde se operan las pollas.
//
// (2026-09-03) Esta pantalla vivia en /casa/admin y tenia su propia pestaña
// en la navegacion. Se movio acá por pedido del dueño: no quiere una pestaña
// de administracion mezclada con lo que ve un jugador, porque le impedia
// mirar la app como la mira cualquiera. Ahora todo lo de admin cuelga de
// /admin y el nav es identico para todos.
//
// /casa/admin sigue existiendo y redirige acá, para no romper un link
// guardado.
...
export default async function CasaAdminPage() {
  ...
  // Redundante con el guard de app/(app)/admin/layout.tsx, y se deja a
  // proposito: defensa en profundidad sobre la pantalla que crea pollas.
  ...
  return (
    <div className="pb-28">
      <HeroFrame height="h-[186px]">
        ...
        <h1 className="lp-display mt-1 text-[38px]">Pollas</h1>
